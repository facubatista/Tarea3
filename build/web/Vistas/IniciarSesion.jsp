<%if(session.getAttribute("nickProveedor")!=null){//Si esta iniciada la sesion redirecciona a la pagina de servicios
    ...
    <body>
        <div class="container">
            ...
            <div class="form-signin" >
              ...
              <label id="nickInvalido" class="text-danger" hidden="">Nickname o email incorrecto</label>
        ...
        <script src="/DispositivoMovil/JS/sha1.js"></script>
        <script src="/DispositivoMovil/JS/Sesion.js"></script>
    </body>
</html>
<%}%>